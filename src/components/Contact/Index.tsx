...
export default function Contact(){
    return (
        <div className={style['container']} id='contact'>
            ...
            <Fieldset.Root fontFamily='Sora' size="lg" maxW="lg" bgColor='white' padding={10} border={'1px solid black'} borderRadius={25} >
              <Stack>
                <Fieldset.Legend fontSize={24} color='indigo'>Let's Work Together</Fieldset.Legend>
                  <Fieldset.HelperText >
        ...
        <Button marginTop={10} type="button" alignSelf="flex-start">
          Contact me
            ...
            <Link 
                 ...
                 >
                    <SlSocialLinkedin size={30} color="black" />
                </Link>{" "}
                <Link  
                    marginLeft={5}
                    ...
                    _hover={{borderColor:"white"}}
                 >
                    <SlSocialTwitter size={30} color="black" />
